...
- **graph group** — clusters (isolated hub·too-small·mixed-topic·unlabeled·unassigned source·orphan label·fragile bridge, 7 codes) · gaps (informational — counts the backlog only, the standing bridge ranking held apart) · drift (**only** this one is opt-in — cold-start comparison)
